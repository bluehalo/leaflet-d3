...
// Grid
u.append("path").attr("class","hexbin-grid").attr("transform",function(t){return"translate("+t.x+","+t.y+")"}).attr("d",function(t){return i._hexLayout.hexagon(i.options.radius)}).attr("fill","none").attr("stroke","none").style("pointer-events",i.options.pointerEvents).on("mouseover",function(t,n){i._hoverHandler.mouseover.call(this,i,t,n),i._dispatch.call("mouseover",this,t,n)}).on("mouseout",function(t,n){i._dispatch.call("mouseout",this,t,n),i._hoverHandler.mouseout.call(this,i,t,n)}).on("click",function(t,n){i._dispatch.call("click",this,t,n)}),l.exit().transition().duration(i.options.duration).attr("fill-opacity",.01).attr("stroke-opacity",.01).attr("d",function(t){return i._hexLayout.hexagon(0)}).remove()},_getExtent:function(t,i,e){
