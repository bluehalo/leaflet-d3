...
this._createHexagons(i,t)}},_createHexagons:function(t,n){var i=this,e=i._map.getBounds(),a=i._hexLayout(n),o=i._getExtent(a,i._fn.colorValue,i.options.colorScaleExtent),r=i._getExtent(a,i._fn.radiusValue,i.options.radiusScaleExtent),s=i._linearlySpace(o[0],o[1],i._scale.color.range().length);
