...
this._createHexagons(i,t)}},_createHexagons:function(t,n){var i=this,e=i._map.getBounds(),a=i._hexLayout(n),o=i._getExtent(a,i._fn.colorValue,i.options.colorScaleExtent),r=i._getExtent(a,i._fn.radiusValue,i.options.radiusScaleExtent);
...
var s=i._linearlySpace(o[0],o[1],i._scale.color.range().length);
// Set the scale domains
i._scale.color.domain(s)}
// Set the scale domains
i._scale.radius.domain(r),
/*
		 * Join
...
var e=[[999,999],[-999,-999]];return t.forEach(function(t){var n=t.point[0],i=t.point[1];e[0][0]=Math.min(e[0][0],n),e[0][1]=Math.min(e[0][1],i),e[1][0]=Math.max(e[1][0],n),e[1][1]=Math.max(e[1][1],i)}),{min:e[0],max:e[1]}},_linearlySpace:function(t,n,i){for(var e=new Array(i),a=(n-t)/Math.max(i-1,1),o=0;o<i;++o)e[o]=t+o*a;return e},
// ------------------------------------
// Public API
// ------------------------------------
...
L.HexbinHoverHandler={tooltip:function(s){null==(
// merge options with defaults
s=s||{}).tooltipContent&&(s.tooltipContent=function(t){return"Count: "+t.length});
// Generate the tooltip
var l=u.select("body").append("div").attr("class","hexbin-tooltip").style("z-index",9999).style("pointer-events","none").style("visibility","hidden").style("position","absolute");
// return the handler instance
return l.append("div").attr("class","tooltip-content"),{mouseover:function(t,n){var i=u.event,e=u.mouse(this);l.style("visibility","visible").html(s.tooltipContent(n,t));var a=null;null!=l._groups&&0<l._groups.length&&0<l._groups[0].length&&(a=l._groups[0][0]);var o=a.clientHeight,r=a.clientWidth;l.style("top",""+i.clientY-e[1]-o-16+"px").style("left",""+i.clientX-e[0]-r/2+"px")},mouseout:function(t,n){l.style("visibility","hidden").html()}}},resizeFill:function(){
// return the handler instance
